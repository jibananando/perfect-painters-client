    ...
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content">
            <div className="items-center grid-flow-col">
                <img className='h-20 w-24' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5jsr6-Ck0ywVwUlGo8tdJj-iVt1gSbUpEQritxaQ5bYXA3kokuzTJfbYITq3OKBt_Sbw&usqp=CAU" alt="" />
                <p>Copyright © 2022 - All right reserved by Perfect Painters</p>
            </div>
